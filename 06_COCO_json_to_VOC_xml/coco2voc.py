...
def coco2voc(anno,xml_dir):
    ...
    for i in tqdm(range(len(imgs))):
        xml_content = []
        file_name = imgs[i]['file_name'].split('.')[-2]
        ...
        xml_content.append("	<folder>Annotations</folder>")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path',type = str ,help = 'path to json file.',default="./instances_val2017.json")
